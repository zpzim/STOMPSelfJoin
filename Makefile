...
CFLAGS=-c -lineinfo -arch=sm_37 -O3 -I$(CUDA_DIRECTORY)/include -DNUM_THREADS=$(DEVICES) -DLOG_FREQ=$(LOG_FREQ) #-Xptxas -dlcm=cg #-D__SINGLE_PREC__
RESTARTFLAGS=-D__RESTARTING__
LDFLAGS=-L$(CUDA_DIRECTORY)/lib64 -lcufft -lineinfo
SOURCES=STOMP.cu
OBJECTS=STOMP.o
